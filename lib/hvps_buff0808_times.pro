...
;-
;- This is true also for the non-charge buffers, so the size of
;- the buffer is 4220, which 4096 bytes of data, and 124 bytes of
;- directory.
;- This routine is valid for the non-charge recording mode of the
;- HVPS SEA system.  The buffers have a different way of recording data
;- incomparison to charge-on mode.
;- Written by Donna: 8/14/2001
;-======================================================================

pro hvps_buff0808_times,fn, $
                      buf_ptr,time,times
...
;;;fn_out = 'c:\T28\Idl\output\Elaps_times.txt'
