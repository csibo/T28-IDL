...
pro select_flight_s1, yr, flt_num, title_flt, year, fltno, dir1, dir2
...
; show message
mesFor1999 = 'The 1999 HVPS data for 1999 is not included in the main Menu yet!'
           result1999 = dialog_message(mesFor1999,/Information)
...
if (yr gt 0) and (yr le 7) then begin
