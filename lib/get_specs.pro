...
spec = {	probe_type : [ 1 , 2 , 3 , 4 , 5, 6 ]								, $
			probe_name : [ '_2DC' , 'HVPS' , 'HVPS' , 'HVPS' , 'Hail', 'HVPS']		, $
	   		xscale : [ 1.0 , 2.0 , 2.0 , 2.0 , 1.0, 2.0  ] 						, $
	   		buf_size : [ 1024 , 2048 , 2048 , 2048 , 2048, 2048 ]					, $
	   		x_resolution : [ 25. , 800. , 400. , 400. , 1800., 400.] 				, $
	   		y_resolution : [ 25. , 200. , 200. , 200. , 1800., 200. ]				, $ ;um
	   		clock_factor : [ 50000. , 25000. , 25000. , 25000. , 50000. , 25000.]	, $
	   		np : [ 1024 , 1000 , 1500 , 2000 , 1000, 2000 ]						, $
	   		nl : [ 32 , 256 , 256 , 256 , 64 , 256]								, $
	   		nps : [ 1024 , 5000 , 5000 , 6000 , 1000, 6000]						, $
	   		fresnel_dcl : [ 160.0 , 293.0 , 293.0 , 293.0 , 99.0 , 293.0 ]			, $		;um 2DC
	   		arm_width : [ 6.1 , 20.3 , 20.3 , 20.3 , 99.0, 20.3 ]	 				, $		;cm 2DC
	   		mask1 : [ 0	, 26 , 26 , 26 , 0, 28]								, $
	   		mask2 : [ 31 , 234 , 234 , 234 , 63, 224 ]							, $
	   		pan_x : [ 1024 , 500 , 2500 , 1400 , 600, 1000 ]					, $
	   		pan_y : [ 55 , 256 , 256 , 256 , 64, 256 ]	  						, $
	   		num_diodes : [ 32 , 256 , 256 , 256 , 64, 256]						, $
	  		...
	  		buf_path : [ dir2, $
	  					 dir2, $
	  					 idl_file +path_sep()+'ouput', $
	  					 dir2, $
	  					 dir2, $
	  					 dir2] ,$
	  		img_sea_tag : [ 300 , 6000 , 999 , 6000 , 320, 66 ], $	; 66 = 0x4242 for images for 1995 data				, $
	  		mdf_sea_tag : [ 301 , 6001 , 999 , 6001 , 999, 65 ], $	; 65 = 0x4141 for TAScnts for the 1995 data				, $
	  		et_sea_tag : [ 302 , 6002 , 999 , 6002 , 999, 69 ], $	; 69 = no meaning for the 1995 data				, $
