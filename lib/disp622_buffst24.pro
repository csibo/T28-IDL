...
;
;-7/8/2002 - modified to display real size of HVPS recorded particles
;- and to be able to select the particles and see the corresponding charge
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

pro disp622_buffsT24_event,ev
...
tv,congrid(img_disp,xs(1), 128),/order
...
skip_bytes = intarr(43)        ; valid for flights after 6/22/00
skip_bytes2 = bytarr(1)
hvps98_buff_times,fn_hvps,buf_ptr,time,times,fltnos
...
skip_bytes2 = bytarr(1)
hvps98_buff622_times,fn_hvps,buf_ptr,time,times,fltnos
...
xmanager,'disp622_buffsT24',base
