...
;				for the 1995 data
; Last modified: March 24, 2008 - added the option to display hail data
;				for 1999 project
;
;---------------------------------------------------------------------

pro select_flight_hail, yr

; select year for the data
yr = 99
while (yr eq 99) do begin
   yr = intarr(1)
...
year = 'yr1999'
   ...
   fltnos = ['Flight 725 - 06/05/1999',$
             'Flight 726 - 06/09/1999',$
             'Flight 727 - 06/10/1999',$
             'Flight 728 - 06/11/1999',$
             'Flight 729 - 06/11/1999',$
             'Flight 730 - 06/12/1999',$
             'Flight 731 - 06/14/1999',$
             'Flight 732 - 06/17/1999',$
             'Flight 733 - 06/18/1999',$
             'Flight 734 - 06/19/1999',$
             'Flight 735 - 06/20/1999',$
             'Flight 736 - 06/21/1999',$
             'Flight 737 - 06/22/1999',$
             'Return']
...
year = 'yr2002'
  ; select a flight number
   ...
   fltnos = ['Flight 781 - 06/11/2002 (No charge)',$
             'Flight 782 - 06/12/2002 (No charge)',$
             'Flight 785 - 06/16/2002 (No charge)',$
             'Return']
